<template>
    <h1 class="text-2xl py-4 font-semibold">Dashboard</h1>
    <div class="min-h-screen bg-gradient-to-br from-[#d1f4f2] to-[#d7fbe8] p-6">
        <div class="p-6 rounded-2xl backdrop-blur-md bg-white/30 shadow-md mb-4">
            <h2 class="p-4 text-xl font-semibold text-gray-800 border-b">Sales & Stocks In</h2>
        ...
        <div class="p-6 rounded-2xl backdrop-blur-md bg-white/30 shadow-md mb-4">
            <div class="rounded-lg">
                <h2 class="p-4 text-xl font-semibold text-gray-800 border-b">Category wise Inventory Activity on weekly basis</h2>
        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="p-6 rounded-2xl backdrop-blur-md bg-white/30 shadow-md mb-4 data-table">
                ...
                <div>
                    <div class="text-xl font-semibold p-4 border-b border-solid border-gray-800">Top Over Stock Products</div>
                    <div class="p-4">
            ...
            <div class="p-6 rounded-2xl backdrop-blur-md bg-white/30 shadow-md mb-4">
                ...
                <div>
                    <div class="text-xl font-semibold p-4 border-b border-solid border-gray-800">Top Under Stock Products</div>
                    <div class="p-4">
            ...
            <div class="p-6 rounded-2xl backdrop-blur-md bg-white/30 shadow-md mb-4">
                ...
                <div>
                    <div class="text-xl font-semibold p-4 border-b border-solid border-gray-800">Top Over Stock categories</div>
                    <div class="p-4">
            ...
            <div class="p-6 rounded-2xl backdrop-blur-md bg-white/30 shadow-md mb-4">
                ...
                <div>
                    <div class="text-xl font-semibold p-4 border-b border-solid border-gray-800">Top Under Stock categories</div>
                    <div class="p-4">
